...
{
    NSComparisonResult result = [self.end compare:aGameResult.end];
...
{
    NSComparisonResult result = [@(self.score) compare:@(aGameResult.score)];
    if (result == NSOrderedAscending)
        return NSOrderedDescending;
    else if (result == NSOrderedDescending)
        return NSOrderedAscending;
...
{
    NSComparisonResult result = [@(self.duration) compare:@(aGameResult.duration)];
    if (result == NSOrderedAscending)
        return NSOrderedDescending;
    else if (result == NSOrderedDescending)
        return NSOrderedAscending;
